...
export default function HeroSection() {
    return (
        <div className=' relative'>
            <Image className=' w-full sm:max-h-screen max-h-[348px]' src="https://static.wixstatic.com/media/82fcd3_47a465bb9c6f4b52a0cc83f281806af8~mv2.jpg/v1/fill/w_1127,h_784,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/82fcd3_47a465bb9c6f4b52a0cc83f281806af8~mv2.jpg" height='682' width='1100' />
